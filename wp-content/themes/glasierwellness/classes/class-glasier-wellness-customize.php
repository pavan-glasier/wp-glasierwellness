...
if ( ! class_exists( 'glasier_wellness_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since Glasier Wellness 1.0
	 */
	class glasier_wellness_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'glasierwellness' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'glasierwellness' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'glasierwellness' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'glasierwellness' ),
						'full'    => esc_html__( 'Full text', 'glasierwellness' ),
					),
				)
			);
			...
			include_once get_theme_file_path( 'classes/class-glasier-wellness-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type( 'glasier_wellness_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new glasier_wellness_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'glasierwellness' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
