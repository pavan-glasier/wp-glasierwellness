...
<?php if (have_rows('slides', 'option')) : ?>
    ...
    <section id="hero" class="hero-wrap style2">
        <div class="hero-slider-one owl-carousel ">
            <?php while (have_rows('slides', 'option')) : the_row();
                ...
                ?>
                <div class="hero-slide-item hero-bg-5 bg-f" style="background-image: url('<?php echo $slide_background_image; ?>');">
                    <div class="container">
                        <div class="row gx-5 align-items-center">
                            <div class="col-lg-6 col-md-9">
                                <div class="hero-content">
                                    ...
                                    ?>
                                        <div class="hero-btn">
                                            <a href="<?php echo esc_url($link_url); ?>" class="btn style2" target="<?php echo esc_attr($link_target); ?>">
...
<?php while (have_rows('sections')) : the_row(); ?>
    <?php if (get_row_layout() == 'section_1') :
        ...
        <section class="hero-wrap style8 mt-0 pt-100 pb-100">
                    ...
                    <div class="col-lg-5 col-md-12 detailform">
                        <?php if (!empty($form_group['heading'])) : ?>
                            <div class="hero-content" data-speed="0.10" data-revert="true">
                                <div class="title-wrap">
                                    <h2 class="h1 double-title double-title--white double-title--center double-title--vcenter text-left" data-title="<?php echo strtoupper( $form_group['heading'] ); ?>">
                        ...
                        <?php endif; ?>
                        <?php echo do_shortcode('[contact-form-7 id="' . $form_group['form_select']->ID . '" html_class="form-wrap" html_id="contactForm"]') ?>
                    </div>
